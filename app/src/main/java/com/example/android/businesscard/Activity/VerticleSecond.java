...
public class VerticleSecond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vf_address = findViewById(R.id.vs_address);
        vf_email = findViewById(R.id.vs_email);
        vf_name = findViewById(R.id.vs_name);
        vf_title = findViewById(R.id.vs_title);
        vf_contact = findViewById(R.id.vs_contact);
        vf_website = findViewById(R.id.vs_website);
        vf_post = findViewById(R.id.vs_post);
