...
public class VerticleFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verticle_first);
        vf_address = findViewById(R.id.vf_address);
        vf_email = findViewById(R.id.vf_email);
        vf_name = findViewById(R.id.vf_name);
        vf_title = findViewById(R.id.vf_title);
        vf_contact = findViewById(R.id.vf_contact);
        vf_website = findViewById(R.id.vf_website);
        vf_post = findViewById(R.id.vf_post);
        ...
        android.support.v7.widget.Toolbar toolbar = findViewById(R.id.vfirst_toolbar);
